...
from generators.pipeliner import Input, Output, Component
from generators.float import single_to_float, float_to_single
from generators.float import double_to_float, float_to_double
import generators.float
import generators.pipeliner
...
Output(
    ...
    "int_to_single_z",
    float_to_single(
        generators.float.int_to_float(Input(int_to_single, 32, "int_to_single_a"))
    ),
)
...
Output(
    ...
    float_to_single(
        generators.float.unsigned_to_float(
